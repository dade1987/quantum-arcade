...
53 livelli interattivi che partono dalle **basi di matematica delle medie**, passano dal
...
resources/views/           LE PAGINE. Una view per pagina per lingua, un layout per tutte
  ...
  lessons/{it,en,es}/      i 53 livelli, con il nome dell'ID (lo slug sta nell'indirizzo)
...
```bash
npm test                 # motore del gioco (438 test) + validatore + stato delle lingue
