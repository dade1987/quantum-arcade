@extends('layouts.page', [
    ...
    'description' => 'Corso-videogioco gratuito in italiano per imparare l\'informatica quantistica da zero: onde, fase, numeri complessi, trasformata di Fourier (DFT), qubit, porte, entanglement, Grover, QFT e algoritmo di Shor. 46 livelli interattivi con simulatore quantistico reale. Di Davide Cavallini.',
    'ogTitle' => 'Quantum Arcade — impara l\'informatica quantistica giocando',
    'ogDescription' => '46 livelli interattivi in italiano: dalle onde alla trasformata di Fourier quantistica e all\'algoritmo di Shor. Con simulatore quantistico vero e sblocco per padronanza.',
])
  ...
  "@graph": [
    {
      ...
      "description": "Corso interattivo gratuito in italiano che insegna l'informatica quantistica partendo dalle onde e dalla trasformata di Fourier fino alla QFT e all'algoritmo di Shor, tramite 46 livelli giocabili con simulatore quantistico a vettore di stato.",
      "inLanguage": "it",
