@extends('layouts.page', [
    ...
    'description' => 'Corso-videogioco gratuito in italiano per imparare l\'informatica quantistica da zero: onde, fase, numeri complessi, trasformata di Fourier (DFT), qubit, porte, entanglement, Grover, QFT e algoritmo di Shor. 28 livelli interattivi con simulatore quantistico reale. Di Davide Cavallini.',
    'ogTitle' => 'Quantum Arcade — impara l\'informatica quantistica giocando',
    'ogDescription' => '28 livelli interattivi in italiano: dalle onde alla trasformata di Fourier quantistica e all\'algoritmo di Shor. Con simulatore quantistico vero e sblocco per padronanza.',
])
  ...
  "@graph": [
    {
      ...
      "description": "Corso interattivo gratuito in italiano che insegna l'informatica quantistica partendo dalle onde e dalla trasformata di Fourier fino alla QFT e all'algoritmo di Shor, tramite 28 livelli giocabili con simulatore quantistico a vettore di stato.",
      "inLanguage": "it",
      ...
      "teaches": [
        "Onde: ampiezza, frequenza, periodo, fase",
...
<main class="wrap">
  ...
  <div style="padding:46px 0 6px">
    ...
    <p class="lead">
      Ventotto livelli interattivi che partono dalle <b>basi di matematica delle medie</b>, passano dalle <b>onde</b>
      (frequenza, periodo, fase) e arrivano fino alla <b>trasformata di Fourier quantistica</b> e all'<b>algoritmo di Shor</b>.
  ...
  La <b>Parte 0</b> e il <b>livello 1</b> sono sempre aperti.</p>
  <div id="map"></div>
