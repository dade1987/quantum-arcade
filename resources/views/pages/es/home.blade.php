@extends('layouts.page', [
    ...
    'description' => 'Curso-videojuego gratuito en español para aprender computación cuántica desde cero: ondas, fase, números complejos, transformada de Fourier (DFT), cúbits, puertas, entrelazamiento, Grover, QFT y algoritmo de Shor. 54 niveles interactivos con un simulador cuántico real. De Davide Cavallini.',
    'ogTitle' => 'Quantum Arcade — aprende computación cuántica jugando',
    'ogDescription' => '54 niveles interactivos en español: de las ondas a la transformada de Fourier cuántica y al algoritmo de Shor. Con un simulador cuántico de verdad y desbloqueo por dominio.',
])
  ...
  "@graph": [
    {
      ...
      "description": "Curso interactivo gratuito en español que enseña computación cuántica partiendo de las ondas y la transformada de Fourier hasta la QFT y el algoritmo de Shor, con 54 niveles jugables y un simulador cuántico de vector de estado.",
      "inLanguage": "es",
