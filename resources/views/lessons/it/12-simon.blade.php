...
= 1 1 0 1      → f(1011) = f(1101)</code></pre>
    ...
    },
    {
      ...
      after: confronto({
        titolo: 'Trovare un periodo nascosto: le due strade',
        livello: 'k5-costo',
        vaiA: 'Ripassa esponenziale contro polinomiale (livello K·5)',
        classico: {
          titolo: 'Cercare una collisione',
          html: `<p>Chiedi valori a caso e aspetti che due coincidano. Il paradosso dei compleanni ti aiuta —
                 non servono 2^n domande ma la loro radice — e non basta comunque.</p>
                 <p class="mb0"><b>√(2^n)</b> domande: resta <b>esponenziale</b> nel numero di bit.</p>`,
        },
        quantistico: {
          titolo: 'Simon',
          html: `<p>Ogni interrogazione quantistica non restituisce un valore, ma <b>un'equazione</b> che il
                 segreto deve soddisfare. Bastano n−1 equazioni indipendenti per inchiodarlo.</p>
                 <p class="mb0"><b>n</b> domande circa, più un sistema lineare da risolvere: <b>polinomiale</b>.</p>`,
        },
        numeri: [
          { cosa: 'segreto di 40 bit', classico: '~1.000.000 domande', quantistico: '39' },
          { cosa: 'segreto di 80 bit', classico: '~10²⁴ domande', quantistico: '79' },
          { cosa: 'tipo di guadagno', classico: '—', quantistico: 'esponenziale (dimostrato)' },
        ],
        verdetto: `<b>Questo è il salto che Grover non fa.</b> Grover dimezza l'esponente; qui l'esponente
                   sparisce. La differenza sta tutta nel fatto che qui una <b>struttura</b> c'è — una
                   periodicità nascosta — e l'interferenza sa vederla. Shor farà la stessa identica cosa su un
                   periodo diverso.`,
      }),
    },
    {
